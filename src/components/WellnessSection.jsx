...
const WellnessSection = ({ onAddToCart }) => {
  ...
  return (
    ...
    <section id="wellness" ref={sectionRef} className="relative w-full bg-gradient-to-b from-[#eaffea] via-[#f0fbf0] to-[#eaffea] overflow-hidden">
      ...
      <div className="relative z-10">
        <WellnessProducts onAddToCart={onAddToCart} />
        <section id="reviews">
          <Testimonials />
        </section>
        <PartnersAndFooter />
